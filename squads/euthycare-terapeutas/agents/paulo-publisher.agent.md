---
id: "squads/euthycare-terapeutas/agents/paulo-publisher"
...
## Conta alvo
- **Instagram:** @euthycare
- **Late account_id:** `69e614df7dea335c2b1445d7`
- **Late profile_id:** `69e6143782a913872783eec5`

## Processo de publicação

1. Lê caption e hashtags de `squads/euthycare-terapeutas/output/[run]/v1/post-draft.md`
2. Combina: `caption + "\n\n" + hashtags`
...
curl -s -X POST "https://getlate.dev/api/v1/media/upload" \
  ...
  -F "accountId=69e614df7dea335c2b1445d7"
...
curl -s -X POST "https://getlate.dev/api/v1/posts" \
  ...
  -d '{
    "accountIds": ["69e614df7dea335c2b1445d7"],
...
## Em caso de erro
Guardar caption em `output/pending-post.md` e informar utilizadora.
