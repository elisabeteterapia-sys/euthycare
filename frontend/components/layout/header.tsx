    ...
    <header className="sticky top-0 z-50 bg-cream-100/90 backdrop-blur-md border-b border-cream-300">
      <div className="container-app flex h-16 items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2 flex-shrink-0">
          ...
          <Link href="/euthy-lancamento#lista">
            <Button size="sm">Lista de espera</Button>
          </Link>
        </div>
        ...
        <nav className="container-app py-4 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2 pt-3 mt-2 border-t border-cream-300">
            <Link href="/agendamento" onClick={() => setOpen(false)}>
              <Button variant="outline" size="sm" className="w-full">Agendar consulta</Button>
            </Link>
            <Link href="/euthy-lancamento#lista" onClick={() => setOpen(false)}>
              <Button size="sm" className="w-full">Lista de espera</Button>
            </Link>
